                                    ...
                                    <div class="col-lg-7 col-md-12 col-sm-4">
                                        <div class="cs-share-right">
                                            <ul class="cs-social">
                                                ...
                                                <li><a href="{{ $blog->google_plus }}"><i class="fa fa-google-plus"></i></a>
                                                </li>
                                                <li><a href="{{ $blog->instagram }}"><i class="fa fa-instagram"></i></a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                            ...
                            <div class="course-list">
                                @foreach ($blogs as $blog)
                                    <div class="w-cs-single">
                                        <img src="{{ asset($blog->image) }}" alt="image">
                                        <div class="fix">
                                            <p><a href="{{ route('blog.details', $blog->id) }}">{{ $blog->title }}</a>
                                            </p>
                                            <span><i class="fa fa-clock-o"></i>
                                                {{ date('F j, Y', strtotime($blog->creating_date)) }}</span>
                                        </div>
                                    </div>
                                @endforeach
